...
public class depositWindow {
	...
	public depositWindow(Stage stage,ATM atm)
	{
		this.stage = stage;
		this.atm = atm;
	}
	public void prepareScene() {
		...
		titleLabel.setText("Enter the amount to be deposited:");
		grid1.add(titleLabel,0 ,10 );
		Label display = new Label();
		grid1.add(display, 0, 11);
		...
		button0.setOnAction(event ->{
			...
			atm.balanceAfterDeposit(amount);
			amount = "";
			display.setText(amount);
